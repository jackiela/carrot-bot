    ...
    try:
        ...
        if last_version != CURRENT_VERSION:
            ...
            update_notes = [
                ...
                "",
                "### ⚖️ 經濟系統平衡 (重要)",
                "• **【修正】** 裝飾品收益邏輯重構：現在由後台穩定發放，解決每日登入金額異常問題。",
                "• **【限制】** 新增收益封頂機制：確保經濟平衡，單日與離線補償皆已設定合理上限。",
                "",
                "### 📦 全新功能：儲藏室與交易",
                "• **【新增】** 指令 `!倉庫`：農場總覽升級！現在可以查看所有收成的蘿蔔庫存。",
                "• **【新增】** 指令 `!賣出`：現在可以將收成的蘿蔔換成金幣囉！稀有蘿蔔更值錢！",
                "  *(用法：!賣出 黃金蘿蔔 5)*",
                "",
                "### 🗺️ 近期預告：冒險系統 (Coming Soon)",
                "• **【近期開放】** 帶上你的蘿蔔夥伴去探險吧！冒險功能即將開放",
                "",
                "### 🖼️ 系統優化",
                "• **【優化】** 修復農場總覽卡片圖片顯示與時間格式，畫面更清爽。",
                "",
                "✨ 快輸入 `!農場總覽` 或 `!倉庫` 體驗新功能吧！"
            ]
            # --- 結束更新日誌 ---
